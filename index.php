    ...
    <div class="about-me container">
      ...
      <div class="row">
        <div class="col-lg-4" data-aos="fade-right">
          <img src="assets/img/Karim.jpeg" class="img-fluid" alt="" style=" width: 90%;">
        </div>
      ...
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="resume-item pb-0">
            <h4>Karim Maged</h4>
            <p><em>Innovative and deadline-driven Pogrammer with 1+ years of experience Frontend and Backend user-centered  from initial concept to final, polished deliverable.</em></p>
            <p>
            <ul>
          ...
          <div class="resume-item">
            ...
            <h5>2008 - 2016</h5>
            <p><em>Primary and preparatory  Education</em></p>
            <p> I Completed primary education in Egypt and a preparatory level were located between Egypt and Saudi Arabia.
Secondary and University Education: Saudi Arabia</p>
          </div>
          <div class="resume-item">
            <h4>Bachelor of Computer Science</h4>
            <h5>2020 - 2024</h5>
            <p><em>Qassim University, Buraydah, Qassim</em></p>
            <p>I pursued my undergraduate education at Qassim University, where I majored in Computer Science. I am passionate about the field of web technologies and artificial intelligence, and I am committed to staying at the forefront of innovation and knowledge in these areas.</p>
          </div>
        </div>
        <div class="col-lg-6">
